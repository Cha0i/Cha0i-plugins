...
public class cha0iOverlay extends Overlay
{
	private static final int Z_OFFSET = 200;
	private static final int MAX_DISTANCE = 2550;

	private final Client client;
	private final cha0iplugins plugin;
	private final cha0ipluginsConfig config;
	private final SkillIconManager skillIconManager;

	@Inject
	private cha0iOverlay(
		Client client, cha0iplugins plugin, cha0ipluginsConfig config, SkillIconManager skillIconManager)
	{
		this.client = client;
		this.plugin = plugin;
		this.config = config;
